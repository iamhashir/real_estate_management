  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 text-ink-500 hover:text-ink-700 transition-colors rounded p-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aqua-400"
        aria-label="Dismiss"
      >
        <X size={13} />
      </button>
